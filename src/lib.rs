...
// The composition root depends on the real leaf crates rather than
// vendored IPC clients — `susi::susi_error` stays reachable for API
// stability via this re-export.
pub use susi_error;
