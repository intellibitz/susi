...
pub(crate) fn mac_tag(key: &[u8; 32], fields: &[&str]) -> String {
...
pub(crate) fn node_x25519_secret() -> Option<x25519_dalek::StaticSecret> {
...
pub(crate) fn peer_x25519_public(pubkey_hex: &str) -> Option<x25519_dalek::PublicKey> {
